        ...
        <Card className='mb-0'>
          <CardBody>
            ...
            <CardTitle tag='h4' className='mb-1'>
              Welcome to IHVN Central Database! 👋
            </CardTitle>
            ...
            <Form className='auth-login-form mt-2' onSubmit={handleSubmit} noValidate={false}>
              <div className='mb-1'>
                <Label className='form-label' for='login-email'>
                  Username
                </Label>
                <Input type='text' id='login-email' placeholder='Enter username' 
                  ref={userRef} value={values.userName} onChange={handleChange} name="userName" required 
                 />
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginBasic)
